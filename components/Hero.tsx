      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-semibold mb-4 text-gray-800 dark:text-gray-200">
            Ich bin <span className="text-blue-600 dark:text-blue-400">Ihr Name</span>
          </h2>
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-12 max-w-3xl mx-auto">
            Ich erstelle moderne, benutzerfreundliche Webanwendungen mit den neuesten Technologien.
            Leidenschaftlich über Clean Code, Performance und User Experience.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="#projects"
              className="px-8 py-4 border-2 border-blue-600 text-blue-600 dark:border-blue-400 dark:text-blue-400 rounded-lg font-semibold hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-all duration-300"
            >
              Projekte ansehen
            </a>
          </div>
